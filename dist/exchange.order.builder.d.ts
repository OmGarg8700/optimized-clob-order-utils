...
export declare class ExchangeOrderBuilder {
    ...
    constructor(contractAddress: string, chainId: number, signer: Wallet | JsonRpcSigner, signerAddress: string, generateSalt?: typeof generateOrderSalt);
    /**
     ...
     */
    buildOrder({ maker, taker, tokenId, makerAmount, takerAmount, side, feeRateBps, nonce, }: OrderData): Promise<Order>;
    /**
