...
export class ExchangeOrderBuilder {
    ...
    signerAddress;
    generateSalt;
    constructor(contractAddress, chainId, signer, signerAddress, generateSalt = generateOrderSalt) {
     ...
     */
    async buildOrder({ maker, taker, tokenId, makerAmount, takerAmount, side, feeRateBps, nonce, }) {
        return {
